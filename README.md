...
| `linux-soplos-x3d` | Optimized for AMD CPUs with 3D V-Cache (5800X3D, 7800X3D…) | BORE, NTSYNC, X3D |

> Since kernel 7.2.4 (package revision -2), binder support is enabled in every variant, allowing the use of Waydroid.
